...
CLASSES_LIST = ["LateralRaise", "DeadLift", "Squat", "Lunges", "Jump&Jacks", "PushUp", "BarbelRow", "BarbelBicepCurl", ""]
...
def main():  
    ...
    if uploaded_file is not None:
        ...
        with open(os.path.join("C:\\Users\\Karla\\Desktop\\video\\",uploaded_file.name.split("/")[-1]),"wb") as f:
            f.write(uploaded_file.getbuffer())
        st.success("File Uploaded Successfully")
                       
        if st.button('Classify The Video'):
            # Construct the output video path.
            output_video_file_path = "C:\\Users\\Karla\\Desktop\\output video\\"+uploaded_file.name.split("/")[-1].split(".")[0]+"_output1.mp4"
            with st.spinner('Wait for it...'):
                # Perform Action Recognition on the Test Video.
                predict_on_video("C:\\Users\\Karla\\Desktop\\test_model\\"+uploaded_file.name.split("/")[-1], output_video_file_path, SEQUENCE_LENGTH)
                ...
                os.chdir('C:\\Users\\Karla\\Desktop\\test_model\\')
            ...
            video_file = open("C:\\Users\\Karla\\Desktop\\video\\" + 'output1.mp4', 'rb') #enter the filename with filepath
